...
<?php ubermenu( 'main' , array( 'theme_location' => 'footer_links' ) ); ?>
							</nav> 
<div class="totop">
      <div id="backtotop">Scroll to Top</div>
    </div>

<div style="float:left;width:58%;margin-left:2%;margin-bottom:20px;margin-top:-20px;"><script>
  (function() {
...
Copyright © <?php echo date( 'Y' ); ?>  Halo, Purely for Pets
 ...
 <!-- end footer -->
	...
	<?php wp_footer(); // js scripts are inserted using this function ?><!-- start number replacer -->
