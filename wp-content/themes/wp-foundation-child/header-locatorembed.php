...
<link href="/p7ttm/p7TTM03.css" rel="stylesheet" type="text/css" media="all">
<script type="text/javascript">
P7_opTTM('id:p7Tooltip_1','id:SHARE','p7TTM03',1,150,10,0,1,0,0,1,300,0,1,1,0,0,0,1);
</script>
...
<div id="top-locator">
<div id="top-locator-info"><h2><a href="#">Where to Buy</a></h2><div id="sl"><form method="post" action="https://halopets.com/locator-embed"><input name="zip" type="text" placeholder="zip/postal"/><select id="dist" name="dist"> <option value="20" selected="selected">20</option><option value="5">5</option>
<option value="10">10</option></select><select name="units"><option value="mi">mi</option><option value="km" >km</option></select><input type="hidden" id="dist" name="dist" value="20"/><input type="hidden"  name="units" value="mi"/><input type="submit" id="sl-button1" class="sl-buttonText" name="search" style="margin-top:8px;clear:both;"></form></div><div class="clearfix";></div>
</div>
...
<div id="banner-locator-info" style="float:left;"><h2>Where to Buy</h2>
<div id="sl"><form method="post" action="https://halopets.com/locator-embed"><input name="zip" type="text" placeholder="zip/postal"/><select id="dist" name="dist"> <option value="20" selected="selected">20</option><option value="5">5</option>
<option value="10">10</option></select><select name="units"><option value="mi">mi</option><option value="km" >km</option></select><input type="hidden" id="dist" name="dist" value="20"/><input type="hidden"  name="units" value="mi"/><input type="submit" id="sl-button1" class="sl-buttonText" name="search" ></form></div><div class="clearfix";></div>
...
<div id="SHARE">
  <div class="addthis_sharing_toolbox"></div>
			...
			</div></div><div style="background-image:url(/wp-content/uploads/2015/02/white-top-tornedge.png);background-repeat:repeat-x;background-position:right top;height:12px;"></div></div><div style="background-color: #fff; padding: 10px;margin-bottom:-18px;">