<?php
/*
Template Name: Full Width rescue Landing Page
*/
?>

<?php get_header(FiF); ?>
<div id="top-rescue">
<div id="top-campaign-info">
  <h3><a href="#">#RescueFilm Series</a></h3>
  Sponsored and produced by Halo, Purely for Pets   <div class="sm-box">
...
<div id="banner-campaign-info">
    <h3><a href="#">#Rescue Film Series</a></h3>
    Sponsored and produced by Halo, Purely for Pets
       <div class="sm-box">
<a href="http://facebook.com/HaloPets" target="_blank"><div class="fb-button"></div></a>
<a href="http://twitter.com/HaloPets" target="_blank"><div class="tw-button"></div></a>
<a href="http://instagram.com/HaloPets" target="_blank"><div class="inst-button"></div></a>
