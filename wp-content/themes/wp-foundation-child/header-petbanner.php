...
<!-- End of Google Analytics Code --></head>
	...
	<body <?php body_class(); ?> style="background-image:url(/wp-content/uploads/2016/10/body-bg-header.png);">
...
<div class="clearfix";></div>
            ...
            <div style="width:100%;max-height:350px;" class="hide-mobile-1">
<div style="background-image:url(/wp-content/uploads/2016/11/amazon-header-ill-1.png);background-position:center top;background-repeat:no-repeat;padding-bottom:27%;background-size:contain;max-width:980px;margin:-80px auto 0 auto;"></div></div>

<div style="width:100%;max-height:350px;" class="show-mobile-1">
<div style="background-image:url(/wp-content/uploads/2016/11/amazon-header-ill-1.png);background-position:center top;background-repeat:no-repeat;padding-bottom:27%;background-size:contain;max-width:980px;margin:0px auto 0 auto;"></div></div>
            
            <div style="background-image:url(/wp-content/uploads/2015/02/white-top-tornedge.png);background-repeat:repeat-x;background-position:right top;height:12px;"></div></div><div style="background-color: #fff; padding: 10px;margin-bottom:-18px;">
