...
<div id="top-locator">
<div id="top-locator-info"><h2><a href="#">Where to Buy mobile</a></h2><div id="sl"><form method="post" action="https://halopets.com/getcode-mobile.php" target="ifrm"><input name="zip" type="text" placeholder="zip/postal"/><input type="hidden" id="dist" name="dist" value="20"/><select name="units"><option value="mi">mi</option><option value="km" >km</option></select><input type="submit" id="sl-button1" class="sl-buttonText" name="search" style="margin-top:8px;clear:both;"></form></div><div class="clearfix";></div>
</div>
...
<div id="banner-locator-info" style="float:left;"><h2>Where to Buy mobile</h2>
<div id="sl"><form method="post" action="https://halopets.com/getcode-mobile.php" target="ifrm"><input name="zip" type="text" placeholder="zip/postal"/><input type="hidden" id="dist" name="dist" value="20"/><select name="units"><option value="mi">mi</option><option value="km" >km</option></select><input type="submit" id="sl-button1" class="sl-buttonText" name="search" ></form></div><div class="clearfix";></div>
