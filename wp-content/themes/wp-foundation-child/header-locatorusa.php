...
<div id="top-locator-info"><h2><a href="#">Where to Buy</a></h2>

<div id="sl"><form method="post" action="https://halopets.com/getcode-ca.php" target="ifrm"><input name="zip" type="text" placeholder="postal code"/><input type="hidden" id="dist" name="dist" value="20"/><select name="units"><option value="km">km</option><option value="mi">mi</option></select><input type="submit" id="sl-button1" class="sl-buttonText" name="search" style="margin-top:8px;clear:both;"></form></div><div class="clearfix";></div>
</div>
...
<h2>Where to Buy</h2>
 <div style="padding: 10px 20px 0px 0px; margin: 0 0 10px 0; background-image: url(/wp-content/uploads/2016/07/storeLocator.png); background-repeat: no-repeat; background-size: 100px auto; background-position: right center; height: auto;max-width:290px;width:290px;height:auto;float:left;"> <img src="https://halopets.com/wp-content/uploads/2016/05/shop-locally.png" style="width:auto;max-width:180px;height:auto;" alt="" /> </div>
<div id="sl" style="float:left;padding: 10px 0px 0px 0px; margin: 0 0 0px 20px;"><form method="post" action="https://halopets.com/getcode-test.php" target="ifrm"><input name="zip" type="text" placeholder="postal code"/><input type="hidden" id="dist" name="dist" value="20"/><select name="units"><option value="mi">mi</option><option value="km" >km</option></select><input type="submit" id="sl-button1" class="sl-buttonText" name="search" ></form></div>
