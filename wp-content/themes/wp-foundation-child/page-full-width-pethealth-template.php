<?php
/*
Template Name: Full Width Pet Health Page*/
?>

<?php get_header(pethealth); ?>
 
<div id="top-pethealth">
<div id="top-aboutus-info"><h3><a href="#">Pet Health</a></h3>Important pet information<br> and veterinary advice
<div class="sm-box">
...
<div id="banner-aboutus-info"><h3><a href="#">Pet Health</a></h3>Important pet information<br> and veterinary advice
