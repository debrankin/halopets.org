...
<!--<img src="/wp-content/uploads/2015/08/fk-logo-300.png" style="height:auto;max-width:220px;padding-left:20px;margin-bottom:-10px;"/>-->


<!--<div id="top-fk-info" style="padding-top:10px;"><div style="float:none;"><img src="/wp-content/uploads/2015/08/fk-logo-300.png" style="height:80px;width:auto;"/></div><div style="float:none; width:100%;"><h3>Welcome Kibblers! Thanks for Donating Halo to Animal Shelters</h3></div>-->

<!--<div style="width:80%; margin:0 auto 0 auto;"><h1 style="text-align:center;">Welcome Kibblers! <br />Thanks for Donating Halo to Animal Shelters</h1></div>-->
</header> <!-- end header -->
			</div></div><div style="background-image:url(/wp-content/uploads/2015/02/white-top-tornedge.png);background-repeat:repeat-x;background-position:right top;height:12px;"></div></div><div style="background-color: #fff; padding: 10px;"><a href="#special-offer"><div style="text-align:center;max-width:1000px;margin-left:auto;margin-right:auto;margin-bottom:20px;"><img src="/wp-content/uploads/2016/10/freekibble-banner.png"/></div></a><div class="">