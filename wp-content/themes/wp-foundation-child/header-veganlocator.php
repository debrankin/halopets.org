...
<script>
  ...
  ga('require', 'linker');
  ga('linker:autoLink', ['shop.halopets.com'] );
  ga('send', 'pageview');
...
<div id="top-locator">
<div id="top-locator-info"><h2><a href="#">Where to Buy Vegan Garden Medley for Dogs</a></h2><div id="sl"><form method="post" action="https://halopets.com/getcode-vegan.php" target="ifrm"><input name="zip" type="text" placeholder="zip/postal"/><select id="dist" name="dist"> <option value="20" selected="selected">20</option><option value="5">5</option>
<option value="10">10</option></select><select name="units"><option value="mi">mi</option><option value="km" >km</option></select><input type="hidden"  name="units" value="mi"/><input type="submit" id="sl-button1" class="sl-buttonText" name="search" style="margin-top:8px;clear:both;"></form></div><div class="clearfix";></div>
</div>
...
<div id="banner-locator-info" style="float:left;"><h2>Where to Buy Vegan Garden Medley for Dogs</h2>
<div id="sl"><form method="post" action="https://halopets.com/getcode-vegan.php" target="ifrm"><input name="zip" type="text" placeholder="zip/postal"/><select id="dist" name="dist"> <option value="20" selected="selected">20</option><option value="5">5</option>
<option value="10">10</option></select><select name="units"><option value="mi">mi</option><option value="km" >km</option></select><input type="hidden"  name="units" value="mi"/><input type="submit" id="sl-button1" class="sl-buttonText" name="search" ></form></div><div class="clearfix";></div>
...
<div style="background-color: ; padding: 10px;margin-bottom:-18px;background-image:url(/wp-content/uploads/2015/06/us-can-map-white2.jpg); background-size:100% auto;">